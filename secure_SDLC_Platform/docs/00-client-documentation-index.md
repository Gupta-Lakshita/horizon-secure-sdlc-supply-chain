...
8. [Phase 1 License Management Service](license-management/phase-1-license-management-service.md)
   Read this to understand the Horizon-owned license service, admin workflow, activation tokens, signed entitlements, and trial-to-paid conversion model.
